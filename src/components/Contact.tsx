          ...
          <div className="space-y-6">
            <div ref={contactInfoRef} className={`p-6 rounded-lg ${
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  ...
                  <a href="mailto:gustaveronic@gmail.com" className="hover:text-cyan-500 transition-colors">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <a href="tel:+6285104937022" className="hover:text-cyan-500 transition-colors">
                    +62 851 0493 7022
                  </a>
                </div>
              </div>
            ...
            <div ref={socialMediaRef} className={`p-6 rounded-lg ${
              ...
              <div className="flex space-x-4">
                <a href="https://github.com/gustavohoze" className="text-cyan-500 hover:text-cyan-400 transition-colors">
                ...
                <a href="https://www.linkedin.com/in/gustavo-hoze/" className="text-cyan-500 hover:text-cyan-400 transition-colors">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
